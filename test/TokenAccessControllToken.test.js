// Reference https://github.com/OpenZeppelin/openzeppelin-contracts/blob/master/test/access/AccessControl.test.js

const { BN, expectEvent, expectRevert } = require('@openzeppelin/test-helpers');

const { expect } = require('chai');

const AccessControlMock = artifacts.require('Token');

contract('Token AccessControl', function (accounts) {
  const [ admin, authorized, otherAuthorized, other, otherAdmin ] = accounts;

  const name = 'AccessControlToken';
  const symbol = 'ACT';
  ...
  beforeEach(async function () {
    this.accessControl = await AccessControlMock.new(name, symbol, amount, { from: admin });
  });
