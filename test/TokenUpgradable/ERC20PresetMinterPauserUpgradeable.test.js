...
//    await deployRelayHub(web3, { from: deployer });
//
//    ERC20PresetMinterPauser = await ethers.getContractFactory("ERC20PresetMinterPauserUpgradeable");
//    upgradable = await upgrades.deployProxy(ERC20PresetMinterPauser, [name, symbol], { initializer: 'initialize' });
//    //await upgradable.deployed();
//
////    upgradable = await ERC20PresetMinterPauser.new(name, symbol, { from: deployer });
//
//    console.log(deployer);
////    console.log(await upgradable.getRoleMemberCount(DEFAULT_ADMIN_ROLE));
//    console.log(await upgradable.getRoleMember(DEFAULT_ADMIN_ROLE, 0));
//  });
//
//  it('deployer has the default admin role', async function () {
//    expect(await upgradable.getRoleMemberCount(DEFAULT_ADMIN_ROLE)).to.be.bignumber.equal('1');
//    expect(await upgradable.getRoleMember(DEFAULT_ADMIN_ROLE, 0)).to.equal(deployer);
//  });
//
